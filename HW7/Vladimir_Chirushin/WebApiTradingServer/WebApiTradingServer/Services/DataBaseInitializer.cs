namespace WebApiTradingServer.Services
{
    ...
    public class DataBaseInitializer : IDataBaseInitializer
    {
        ...
        public void Initiate()
        {
            ...
            this.clientManager.AddClient(new Client { Name = "Ludwig Wittgenstein", PhoneNumber = "546-86-43", Balance = (decimal)0 });
            ...
            this.clientManager.AddClient(new Client { Name = "Friedrich Gauss", PhoneNumber = "315-53-23", Balance = (decimal)0 });
            ...
            this.clientManager.AddClient(new Client { Name = "Leonhard Euler", PhoneNumber = "133-35-25", Balance = (decimal)0 });
