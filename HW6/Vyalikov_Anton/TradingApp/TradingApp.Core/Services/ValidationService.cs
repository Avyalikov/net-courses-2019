namespace TradingApp.Core.Services
{
    ...
    public class ValidationService : IValidationService
    {
        ...
        public bool ValidateClientData(Clients client, ILogger logger)
        {
        ...
        public bool ValidateClientsAmount(IEnumerable<Clients> clients, ILogger logger)
        {
            if (clients.Count() < 2)
            {
        ...
        public bool ValidateTransaction(Transactions transaction, ILogger logger)
        {
