namespace TradingApp.Core.Interfaces
{
    ...
    public interface IValidationService
    {
        ...
        bool ValidateClientData(Clients client, ILogger logger);
        bool ValidateClientsAmount(IEnumerable<Clients> clients, ILogger logger);
        bool ValidateTransaction(Transactions transaction, ILogger logger);
    }
}
