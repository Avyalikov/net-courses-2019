namespace TradingApp.Core.Tests
{
    ...
    public class PortfoliosServiceTest
    {
        ...
        public void RegisterPortfolioTest()
        {
            ...
            // Asserts
            portfoliosRepositoryMock.Received(1).Insert(Arg.Is<ClientsPortfolios>(x => x.ClientID == portfolio.ClientID 
        ...
        public void ChangeAmountOfSharesTest()
        {
            ...
            // Asserts
            portfoliosRepositoryMock.Received(1).ChangeAmountOfShares(Arg.Is<ClientsPortfolios>(x => x.ClientID == portfolios.ClientID));
        }
