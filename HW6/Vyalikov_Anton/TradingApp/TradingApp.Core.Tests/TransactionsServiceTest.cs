namespace TradingApp.Core.Tests
{
    ...
    public class TransactionsServiceTest
    {
        ...
        public void AddTransactionTest()
        {
            ...
            // Asserts
            transactionRepositoryMock.Received(1).Insert(Arg.Is<Transactions>(transaction));
        }
        ...
        public void SellOrBuySharesTest()
        {
            ...
            //Assert
            portfolioServiceMock.Received(2).ChangeAmountOfShares(Arg.Any<ClientsPortfolios>());
        ...
        public void ShouldNotBuyAndSellSharesYourself()
        {
            ...
            //Assert
            portfolioServiceMock.DidNotReceive().ChangeAmountOfShares(Arg.Any<ClientsPortfolios>());
