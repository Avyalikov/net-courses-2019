...
namespace Trading.Components
{
    ...
    class JsonPhraseProvider : Interfaces.IPhraseProvider
    {
        ...
        ///// <returns>Phrase string</returns>
        //public string GetPhraseAndSettingsAndReplace(string phraseKey, Dictionary<string,string> settings, params string[] settingsNames)
        //{
        //    string phrase = this.GetPhrase(phraseKey);

        //    foreach (string settingName in settingsNames)
        //    {
        //        phrase = phrase.Replace("@" + settingName, settings[settingName]);
        //    }
        //    return phrase;
        //}
