    ...
    public class StockExchange
    {
        ...
        public void Start()
        {
            ...
            do
            {
                ...
                Console.WriteLine(" 6. Add a new client");
                Console.WriteLine(String.Empty);
                Console.WriteLine("Type the number or 'e' for exit and press Enter: ");

                inputString = Console.ReadLine();
                switch (inputString)
                {
                    case "6":
                        Console.WriteLine("You have chosen 6"); // signal about enter into case
                        AddClient();
